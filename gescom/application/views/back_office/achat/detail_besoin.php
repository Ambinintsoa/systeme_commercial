                ...
                <div class="table-responsive pt-3">
                    ...
                    <tbody>
                        ...
                        <tr >
                            ...
                            <td class="text-center text-muted" style="width: 5%; "><a href="<?php echo site_url("index.php/back_office/BesoinController/deleteDetailBesoinCtrl") ?>/<?php echo $status;?>/<?php echo $idbesoin;?>/<?php  echo $db['iddetail']; ?>"><i data-feather="delete"></i></a></td>
                        </tr>
                                                    <!-- Modal -->
