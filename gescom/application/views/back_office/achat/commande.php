            ...
            <div class="card" id="card<?php echo $k;?>">
              ...
              <div class="card-body">
                ...
                <span >Responsable ------------------------------------</span>
                    ...
                    <br/>
                <br/>
                    <?php if( $commandes[$k][0]['status']  == 1){?>
                        <form action="<?php echo site_url("index.php/back_office/SendMail/sendDemandeCommande")?>" method="POST">
                    <input type="hidden" name="name" value="<?php echo $commandes[$k][0]["idboncommande"]?>">
                    <input type="hidden" name="email" value="<?php echo $commandes[$k][0]["email"]?>">
             ...
             <a href="javascript:;" onclick="print('#card<?php echo $k;?>')" class="btn btn-outline-primary float-right mt-4"><i data-feather="printer" class="me-2 icon-md"></i>Print</a>
                  <?php } ?>
                </div>
              </div>
            </div>
